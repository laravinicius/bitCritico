...
<body>
    ...
    <main style="display: flex; justify-content: center; align-items: center; min-height: 80vh;">
        <form action="/BitCritico/Controller/JogoController.php?action=create" method="POST" enctype="multipart/form-data" style="border: 1px solid #ccc; padding: 30px; border-radius: 8px; background-color: #1f1f1f; color: var(--cor-texto);">
